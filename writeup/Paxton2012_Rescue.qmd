...
Participants were instructed to input numerical responses for all CRT questions. However, many participants used characters (e.g., "nine"), and some included longer written responses. Such responses were recoded using the following criteria: written answers needed to unambiguously and uniquely map to the correct numerical answer. For example:

* CRT-1. Answers were correct if they explicitly said that moses included no animals on the ark (e.g., "zero" or "none" were counted as correct). Answers were incorrect even if they correctly identified the ark is associated with Noah, not Moses; participants need to explicity respond with the equivalent of "0".
* CRT-2. February" recoded as 1. "All of them" recoded as 12" (correct)
* CRT-3. Any written answers which clearly say that eight sheep are alive were recoded as "8", correct.

Answers equivalent to "I don't know" were recoded as 1234, which is an incorrect answer for all questions.
...
In line with the original and Fereday's (2019) first replication, the present replication (henceforth, the second replication) found that moral acceptability ratings were reliable across both conditions (Cronbach's alpha =.73). This justified the use of a single moral acceptability score taken as the mean of judgements across all three dilemmas. There was no significant difference between the proportions of subjects in the CRT-first and Dilemma-first conditions before vs after exclusions. In fact, the proportion was almost identical (Pre-Exclusion CRT-First: 118 of 241 [49%], Post-Exclusion CRT-First: 78 of 160 [49%], x^2 = 0, p = 1), indicating that exclusions had no systematic effect on condition representation.

The present study found no significant difference between the moral acceptability scores in the CRT-first vs Dilemmas-first conditions (CRT-First: M = 2.74; Dilemmas-First: M = 2.96; t(158) = -1.12, p = .26, d = -.18).  In fact, the slight but insignificant trend was that subjects in the Dilemmas-first condition actually judged utilitarian responses as more morally acceptable than subjects in the CRT first condition. This resulted conflicted with the original study (CRT-First: M = 3.77; Dilemmas-First: M = 3.25; t(90) = 2.03, p = .05, d = 0.43), but matched the first replication (CRT-First: M = 3.54; Dilemmas-First: M = 3.66; t(82) = -.36, p = .72, d = .08). 

However, the present study did find a statistically significant positive correlation between CRT scores and moral acceptability scores within the CRT-first condition (r=.24, p=.035). It also found an insignificant relationship in the Dilemmas-First condition (r=.11, p=.31). This result matched the original study (r = .39, p = .001), but conflicted with the first replication, which found no significant correlations between CRT scores and moral ratings in either conditions (CRT-first condition: r = .14, p = .32). 
...
Finally, the present study found that viewing the moral dilemmas before vs after answering CRT questions had no significant effect on CRT scores (CRT-First: M = 2.08; Dilemmas-First: M = 2.18; t(158) = -.57, p = .57). This matched both the original and second replication, and suggests that viewing the dilemmas first did not influence how participants performed on the CRT.

### Commentary

The second replication (present study) employed an experimental design that improved on the original and first replication in several ways. First, it was higher powered than both (post exclusions, n=160 [95% power] compared with original [n=92], and first replication [n=82]). Second, it used newer CRT questions from the CRT-2 and reworded classic CRT questions, to address the first replication's worry about participant familiarity with CRT questions on MTurk impairing the induction of an appropriate reflective state. Third, it used participants from Prolific instead of MTurk, which also addressed the concern about familiarity.

The second replication did not reproduce the main result found in the original: participants who were shown the CRT questions before moral dilemmas did not hold more utilitarian convictions. This result might provide evidence against the claim that reflecting on moral dilemmas produces more utilitarian evaluations. However, the second replication did produce the other main result from the original study: in the CRT-first condition, participants who answered more CRT questions correctly were more likely to have stronger utilitarian convictions. There was no such relationship in the Dilemmas-First condition, which suggests that the observed relationship was not caused by trait-level reflection and utilitarian attitudes. But a state-level explanation -- where correctly answering CRT questions induced a reflective state that caused more utilitarian ratings -- does not fit either, since if that were true we should have observed a significantly higher moral acceptability ratings in the CRT-First vs Dilemma-First groups, which we did not (i.e., the first statistical test).

This is a puzzle. The start of a solution is suggested by adding post-hoc another exclusion. The original study put no limit on duration, while the present study excluded only positive outliers taking than an hour to complete the study (n=4; median duration was 7:37). However, there was a (n=1) participant in the CRT-first condition who took only 95 seconds and returned a high CRT-score of 5, a high moral acceptability average rating of 5.8, and was "definitely familiar" with both the CRT questions and moral dilemmas. In the exploratory analysis, I excluded all participants who took less than 2 minutes on the survey (n=3 overall, n=1 in CRT-first) and correlation between CRT score and Moral Acceptability in the CRT-First condition became insignificant (r=.21, p=.07). As before, there was no significant correlation in the dilemmas-first condition. We can conclude that while there appears to be some slight pattern of positive correlation between CRT proficiency and the strength of one's utilitarian convictions, it is not one that is clear and significant. Further, it is not caused by a trait-level reflection, but neither is it caused by a state-level reflective state induced by the experimental design.

Another explanation might concern how familiar participants are with the CRT questions. Familiarity was a concern of the first replication, and consequentially, the present replication aimed to reduce familiarity. However, the present replication was only moderately successful. 37% of participants self-reported being "unfamiliar" with the CRT questions, while the majority (47%) were "somewhat familiar" and 16% were "definitely familiar". 63% were either "somewhat" or "definitely" familiar, which was an improvement on the replication (where 77% reported being either "somewhat" or "definitely" familiar). The high levels of familiarity might have interrupted the targeted manipulation; perhaps participants in the CRT-first group who were familiar with the question were not induced into an appropriate reflective state. Familiarity with CRT questions had a significant positive correlation with CRT performance (r=.25, p=.001), but familiarity with CRT questions did not have a significant relationship with moral acceptability scores (r=.11, p=.16).
...
Unlike the original or the first replication, the present replication also investigated how familiar participants were with the three moral dilemmas. Familiarity with moral dilemmas showed a similar trend to familiarity with CRT questions. Interestingly, previous exposure to the moral dilemmas appears to have important implications for moral judgements and CRT performance -- in fact, familiarity with dilemmas appears more influential than familiarity with the CRT. Familiarity with the moral dilemmas showed a strong and significant positive correlation with high moral acceptability scores, i.e., with strong utilitarian judgements (r=.30, p=.0001). That is, the more familiar participants were with the moral judgements, the more likely they were to produce utilitarian evaluations. Familiarity with dilemmas also had a strong and significant positive correlation with high CRT scores (r=.33, p.0001). 

In the exploratory analysis, I performed the two main statistical tests on participants who were either completely unfamiliar, or "relatively" unfamiliar (either completely, or somewhat, unfamiliar) with both the CRT questions and moral dilemmas. Even though the analyses were moderately underpowered, they should reveal a trend towards the original study's findings if familiarity was interrupting the induction of a reflective state or influencing moral judgements directly. However, all analyses returned insignificant results; for example, a t-test on participants who were relatively unfamiliar with the CRT (n=131) showed no significant difference between the moral acceptability ratings of CRT-First vs Dilemma-First conditions (p=.63), while the same test on participants who were completely unfamiliar (n=33) was also insignificant (p=.56) Results from all analyses suggests that familiarity with either the CRT or dilemmas was not disrupting the experimental manipulation.

Finally, two more exploratory analyses are of note. First, the data was reanalyzed using pre-exclusion data (n-241), and both main statistical tests were insignificant. Second, there was a significant relationship between duration and moral acceptability scores. Participants who took longer on the survey were significantly more likely to find utilitarian responses as less acceptable (r=-.16, p=.04). Since appropriate reflection requires time, this result must be reconciled with the claim that greater reflection produces stronger utilitarian judgements.

To close, I will discuss some possible conclusions and future directions. There are at least two general explanations of why the present replication was mostly unsuccessful, and both explanations suggest areas of future research. The first explanation is that participant familiarity with CRT and the trolley-problem variants of moral dilemmas is so high that the original experimental result cannot be replicated using the original materials or variants thereof. Perhaps, variants of CRT questions and moral dilemmans, or even the general structure of those types of questions questions are so common in experimental designs (such as those employed on Prolific) that their potency is in general markedly diminished. To address this, future experiments might look to use alternate materials to induce a reflective state and measure utilitarian convictions. However, those paradigms must also be able to justify why the alternate materials manipulate and measure the same constructs.

The second explanation concerns the background theoretical architecture of the original study. Namely, the original study was motivated by a general question regarding the nature of moral judgements. One model has moral judgements as inherently automatic, unconscious, and affective -- which predicts that mere reflection and even deliberative reasoning cannot change moral judgements. The other has initial moral judgements as being quick, automatic, unconscious, and emotional -- but then allows that mere reflection and deliberative reasoning can override the initial unconscious judgements. 

What was unclear in the original study, however, was why we should think the initial moral judgement that is furnished by system-1 automatic processes should be directed towards "deontological" conclusions (i.e., participants are unwilling to actively kill one person to save five), while reason and reflection, which overrides the initial judgement, does so in the direction of making the conclusion more utilitarian (i.e., participants are willing to actively kill one person to save five). These seem like separate predictions, three in fact. The first is that reason and reflection can override initial automatic judgements (whatever these are); the second is that the initial unconscious judgement is generally deontological; the third is that reason and reflection generally make judgements more utilitarian. The original paper threads these three distinct predictions together without much clarity nor justification. Thus, if the three predictions do not hang together, we should expect to see no robust relationships between induced reflection and utilitarian judgements -- as observed in both replications. We could observe this even if it is true that reason and reflection can override initial unvconscious moral attitudes -- they just might do so in the other direction, i.e, making judgements less utilitarian. 

Future studies should provide an updated literature review to defend the network of assumptions that predict the results observed in the original study. It is my suspicion that moral judgements are not so universal nrt generalizable that people are naturally unconsciously deontological and, with reflection, naturally become utilitarian. It seems likely that the situation is more complex, and therefore, more precise and varied experimental designs  are needed (including choice of materials, manipulation, context, and measure) to detect true causal effects. 

Finally, a future rescue might add another element to the experimental design: something we might call a "moral benchmark". Presently, participants are not given any guidance when approaching the moral problems. They are left with complete freedom to interpret the moral situations and responses as they like. But the key experimental prediction is that reflection increases utilitarian responses. It is likely that people naturally have quite different intuitive and reasoned benchmarks for what counts as a morally permissible act. Put differently, a participant upon reflection might come to the conclusion that "persons" are sacred and so it is immoral to sacrifice 1 to save 5 (a classic deontological conviction). A future investigation might address this by adding in an explicitly utilitarian value to all conditions, e.g., before each dilemma, include a statement "On some moral theories, the most important outcome is to save as many people as possible, even if some people have to die to do so". This puts the utilitarian benchmark in plain sight, and participants will make their judgements in light of that benchmark while still being completely free to disvalue it in their ratings. Since this is given to both conditions -- CRT-first and Dilemma-first -- its influence is constant across conditions. The idea is that if the CRT questions induce a reflection state that is morally relevant because it overrides an initially intuitive judgement, in the new setup, reflection is given a moral direction to work towards.
