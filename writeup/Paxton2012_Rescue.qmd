...
### Numeric Score of Replication Closeness


This is a broad measure of how similar the methods of the present rescue are to the methods used in the original study. 

**Numeric score of replication closeness** = 0.75. Both the participant pool and primary experimental manipulation (CRT questions) involved significant changes. However, the overall structure of the experiment is almost identical to the original.
